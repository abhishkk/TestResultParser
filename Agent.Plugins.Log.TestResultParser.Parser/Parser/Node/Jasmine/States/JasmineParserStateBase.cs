...
namespace Agent.Plugins.Log.TestResultParser.Parser
{
    ...
    /// </summary>
    public class JasmineParserStateBase : ITestResultParserState
    {
        ...
        protected JasmineParserStateBase(ParserResetAndAttemptPublish parserResetAndAttempPublish, ITraceLogger logger, ITelemetryDataCollector telemetryDataCollector)
        {
            this.logger = logger;
